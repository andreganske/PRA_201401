...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabalho4
...
${OBJECTDIR}/data/data.o: data/data.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/data.o data/data.c

${OBJECTDIR}/data/file/file_manager.o: data/file/file_manager.c 
	${MKDIR} -p ${OBJECTDIR}/data/file
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/file/file_manager.o data/file/file_manager.c

${OBJECTDIR}/data/partida/partida.o: data/partida/partida.c 
	${MKDIR} -p ${OBJECTDIR}/data/partida
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/partida/partida.o data/partida/partida.c

${OBJECTDIR}/data/partida/random/random_partida.o: data/partida/random/random_partida.c 
	${MKDIR} -p ${OBJECTDIR}/data/partida/random
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/partida/random/random_partida.o data/partida/random/random_partida.c

${OBJECTDIR}/hashtable/hash.o: hashtable/hash.c 
	${MKDIR} -p ${OBJECTDIR}/hashtable
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hashtable/hash.o hashtable/hash.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabalho4
